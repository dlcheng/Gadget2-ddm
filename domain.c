...
void domain_Decomposition(void)
{
  ...
  temp_flag = decay_tree_construct_flag; 
#else
  temp_flag = 0;
#endif

  /* Check whether it is really time for a new domain decomposition */
  if(All.NumForcesSinceLastDomainDecomp > All.TotNumPart * All.TreeDomainUpdateFrequency || temp_flag == 1)
    {
      t0 = second();
