...
#--------------------------------------- Dark matter decay                -dlcheng
OPT +=  -DDECAY_DARK_MATTER               #using our own algorithm              
#OPT +=  -DPETER_HALO_DECAY               #using the decay algorithm described by Peter et al. (2010), dismiss all above

#--------------------------------------- Additional potential              -dlcheng
#OPT +=  -DEXTRA_POTENTIAL=0
                                           # '0' stands for the Milky Way bulge potential 
                                           # '1' stands for the Hernquist profile
#OPT +=  -DAD_EXTRA_POTENTIAL_GROWTH       # AD means adiabatic growth, only be valid with EXTRA_POTENTIAL
#OPT +=  -DAD_EXTRA_POTENTIAL_RELEASE      # release the selected potential with the time of AD_TIME

#--------------------------------------- Halo particle random kick         -dlcheng
#OPT +=  -DHALO_PART_RANDOM_KICK           # random kick will not choose its own timestep
#OPT +=  -DRANDOM_KICK_TIMESTEP            # random kick will choose its own timestep and must be used together with 
                                           # HALO_PART_RANDOM_KICK
...
#--------------------------------------- TreePM Options
OPT   +=  -DPMGRID=666                   #4*N if pure PM, 1.33*N if tree+PM
...
##==========start##>
## For compiling Gadget2 on rct3
ifeq ($(SYSTYPE),"RCT3_mod")
CC       =  mpicc
OPTIMIZE =  -O3 -Wall
#GSL_INCL = -I/opt/share/gsl-1.9/include
#GSL_LIBS = -L/opt/share/gsl-1.9/lib  -Wl,"-R /opt/share/gsl-1.9/lib"
...
#FFTW_INCL= -I/opt/share/fftw-2.1.5/include
#FFTW_LIBS = -L/opt/share/fftw-2.1.5/lib
FFTW_INCL= -I/users/s0902248/Lib/fftw-2.1.5/include
FFTW_LIBS = -L/users/s0902248/Lib/fftw-2.1.5/lib
MPICHLIB = -lmpich -L/opt/share/mpich2-1.4.1p1.intel/lib
HDF5INCL= -I/opt/share/hdf5-1.6.10/include
HDF5LIB= -L/opt/share/hdf5-1.6.10/lib -lhdf5 -lz
endif
##==========stop##>
...
FFTW_INCL=  -I/home/dlcheng/Install/fftw/include
FFTW_LIBS=  -L/home/dlcheng/Install/fftw/lib
MPICHLIB =  -L/home/dlcheng/Install/mpich2-install/lib
HDF5INCL =  
HDF5LIB  =
endif
...
OBJS   = main.o  run.o  predict.o begrun.o endrun.o global.o  \
	 ...
	 pm_periodic.o pm_nonperiodic.o longrange.o \
         extra_potential.o decay_dark_matter.o random_kick.o

INCL   = allvars.h  define.h  proto.h  tags.h  Makefile
