...
void   mw_bulge_potential_accel_ad(FLOAT *pos,FLOAT *bulge_accel,double turn_on_time);
...
void   hernquist_potential_accel_ad(FLOAT *pos, FLOAT *bulge_accel, double turn_on_time);
...
void   random_kick_tab_update(void);

/* decay dark matter */
#ifdef DECAY_DARK_MATTER
void   alloc_decay_tab();
